...
const Index = () => {
  ...
  const handleRemoveSong = (indexToRemove) => {
    ...
    if ((paginaActual - 1) * tarjetasPorPagina >= nuevasCanciones.length && paginaActual > 1) {
      ...
      <main className='main-contenedor'>
        ...
        <div className="main-contenedor-contenido">
          ...
          <div className="columna centro">
            ...
            <table className="tabla-desktop">
              ...
              <tbody>
                {cancionesPaginadas.map((cancion, index) => {
                  const indiceReal = (paginaActual - 1) * tarjetasPorPagina + index;
                  return (
                    <tr key={indiceReal}>
                      <td>
                        <button className="boton-favorito" onClick={() => toggleFavorito(indiceReal)}>
                          {favoritos.includes(indiceReal) ? '⭐' : '☆'}
                        </button>
                      </td>
                      <td>
                      ...
                      <td>
                        <button className="button-list" onClick={() => handleRemoveSong(indiceReal)}>❌</button>
                      </td>
                    </tr>
                  );
                })}
            ...
            <div className="cards-mobile">
              {cancionesPaginadas.map((cancion, index) => {
                const indiceReal = (paginaActual - 1) * tarjetasPorPagina + index;
                return (
                  <div className="card-cancion" key={indiceReal}>
                    ...
                    <div className="card-actions">
                      ...
                      <button className="button-list" onClick={() => handleRemoveSong(indiceReal)}>
                        ❌
                      </button>
                    </div>
                  </div>
          ...
          <div className="columna derecha">
            ...
            <a href="https://www.youtube.com/channel/UCJUYcEdvnYFGajHBW0Nao3w" target="_blank" rel="noopener noreferrer">
              <img src={Trap} alt="recomendación de trap" className="recomendaciones-fotos" />
            </a>
            <a href="https://www.youtube.com/channel/UCT9zcQNlyht7fRlcjmflRSA" target="_blank" rel="noopener noreferrer">
        ...
        {modalReproductor && (
          <PlayerModal
            ...
            onClose={() => setModalReproductor(false)}
          />
        )}
      </main>
